    ...
    buyUpgrade() {
        ...
        const knowledge =
            <div className={"up"} onClick={()=>{
                Meteor.call('battle.add',-(this.state.points));
                ...
                <img src={"./../img/brain"}></img><p>YOU ARE READY TO BE A GOD</p><p className={"red"}>(All points)</p></div>

        const upgrade = [];
        if(this.state.knowledge == false) {
